...
const TextToAudio = () => {
  ...
  return (
    <div className={isDarkMode ? 'dark' : ''}>
      <div className="w-full p-6 bg-white dark:bg-black rounded-lg shadow-md border border-purple-200 dark:border-purple-800 transition-colors duration-300 relative">
        {/* Theme Toggle Button */}
