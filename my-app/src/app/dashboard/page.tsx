...
function FloatingSidebar() {
  ...
  return (
    <div id="main-container" className="flex min-h-screen w-full bg-white dark:bg-black transition-colors duration-300">
      {/* Mobile menu button */}
      {isMobile && (
        <button
      ...
      >
        <div id="sidebar-header" className="flex items-center justify-between p-1 border-b border-purple-600 dark:border-purple-800">
              ...
              <li key={index} id={item.id}>
                ...
                >
                  <item.icon
                    size={20}
                    className={`
                      ${currentItem === item.url ? "text-purple-800 dark:text-white" : "text-white"}
      ...
      >
        ...
        {!["createAvatar", "textToAudio"].includes(currentItem) && (
          <div id="coming-soon-container" className="flex flex-col items-center justify-center h-full">
            <div id="coming-soon-icon" className="text-purple-800 dark:text-purple-400 text-5xl mb-4">
              {(() => {
                const IconComponent = sidebarItems.find(item => item.url === currentItem)?.icon;
                return IconComponent ? <IconComponent size={64} /> : null;
              })()}
            </div>
            <p id="coming-soon-text" className="text-2xl font-semibold bg-gradient-to-r from-purple-800 to-purple-500 dark:from-purple-500 dark:to-purple-300 bg-clip-text text-transparent">
