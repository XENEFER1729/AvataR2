  ...
  const features = [
    {
      ...
      description: "Our advanced AI generates avatars so realistic they're indistinguishable from professional photography."
    },
    {
      icon: <Wand2 size={24} />,
      title: "One-Click Generation",
      description: "Transform your photos into stunning professional avatars with just a single click."
    },
    {
      icon: <ZoomIn size={24} />,
    ...
    },
    {
      ...
      description: "Get your realistic avatars in seconds, not minutes or hours like other services."
    },
    {
      icon: <Download size={24} />,
      title: "Multiple Formats",
      description: "Download your avatars in various formats including PNG, JPEG, and SVG for different use cases."
    }
  ];
